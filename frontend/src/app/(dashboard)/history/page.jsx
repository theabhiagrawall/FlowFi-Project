...
import { transactions, getAuthenticatedUser } from "@/lib/data.js";
import { ArrowDownLeft, ArrowUpRight, ArrowRightLeft } from "lucide-react";
import { cn } from "@/lib/utils.js";
import { format } from "date-fns";

const TransactionIcon = ({ type, fromId, currentUserId }) => {
  if (type === 'deposit') {
                ...
                <Table>
                    ...
                    <TableBody>
                        ...
                        <TableRow key={transaction.id}>
                            ...
                            <TableCell>{isClient ? format(new Date(transaction.date), 'MMM d, yyyy') : ''}</TableCell>
