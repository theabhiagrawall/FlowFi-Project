export const users = [
  { id: 'user-1', name: 'Alice Johnson', email: 'alice@example.com', avatar: 'https://placehold.co/100x100.png', balance: 5420.50, "data-ai-hint": "woman portrait", kycStatus: 'unverified', kycDocumentUrl: null },
  { id: 'user-2', name: 'Bob Williams', email: 'bob@example.com', avatar: 'https://placehold.co/100x100.png', balance: 1250.75, "data-ai-hint": "man portrait", kycStatus: 'pending', kycDocumentUrl: 'https://placehold.co/600x400.png' },
  { id: 'user-3', name: 'Charlie Brown', email: 'charlie@example.com', avatar: 'https://placehold.co/100x100.png', balance: 7890.00, "data-ai-hint": "man portrait", kycStatus: 'verified', kycDocumentUrl: null },
  { id: 'user-4', name: 'Diana Prince', email: 'diana@example.com', avatar: 'https://placehold.co/100x100.png', balance: 3210.25, "data-ai-hint": "woman portrait", kycStatus: 'rejected', kycDocumentUrl: null },
  { id: 'user-5', name: 'Ethan Hunt', email: 'ethan@example.com', avatar: 'https://placehold.co/100x100.png', balance: 10000.00, "data-ai-hint": "man portrait", kycStatus: 'verified', kycDocumentUrl: null },
  { id: 'user-6', name: 'Fiona Glenanne', email: 'fiona@example.com', avatar: 'https://placehold.co/100x100.png', balance: 654.80, "data-ai-hint": "woman portrait", kycStatus: 'pending', kycDocumentUrl: 'https://placehold.co/600x400.png' },
];
